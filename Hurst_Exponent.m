...
%% Test if a time series is random walk, trend following or mean reverting %%

%%The value of H(q) give indication about the fractal nature of the signal. 
%%H(q) = 0.5 corresponds to a Brownian motion, 
%%deviations form 0.5 and dependency on q are indications of multi-fractality and time-correlations.

%% time series can then be characterised in the following manner:

%%H<0.5 H<0.5 - The time series is mean reverting
%%H=0.5 H=0.5 - The time series is a Geometric Brownian Motion
%%H>0.5 H>0.5 - The time series is trending

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% This module calculates the generalized Hurst exponent H(q) from the scaling 
